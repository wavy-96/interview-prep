...
export const eventBus = {
    async handleMessage(ws, session, data, options = {}) {
    ...
    async publishCodeEdit(session, payload) {
        const { code, language } = payload;
        await redis.xadd("events", "type", "code.edited", "sessionId", session.sessionId, "payload", JSON.stringify({ code, language }));
    },
};
