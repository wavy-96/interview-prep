...
const buffers = new Map<string, TranscriptChunk[]>();
const flushTimers = new Map<string, ReturnType<typeof setTimeout>>();

function getBuffer(sessionId: string): TranscriptChunk[] {
